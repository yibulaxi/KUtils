...
public final class Utils {
    ...
    public static String getRandomName(int sex) {
        ...
        String[] boyName = totleBName.split(",");
        String[] grilName = totleGName.split(",");
        int index = 0;
        if (sex == 1) {
            index = random.nextInt(boyName.length);
        } else {
            index = random.nextInt(grilName.length);
        }
        return sex == 1 ? boyName[index] : grilName[index];
    }
